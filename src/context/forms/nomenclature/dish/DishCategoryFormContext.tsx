...
import { DishCategoryDTO, getDishCategories, postDishCategory, putDishCategory, deleteDishCategory, getDishCategoryWithDishes, putDishCategoryWithDishes, postDishCategoryWithDishes } from '../../../../api/nomenclature/dishCategories';
