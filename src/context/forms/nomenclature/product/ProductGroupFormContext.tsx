...
import { ProductGroupDTO, getProductGroups, postProductGroup, putProductGroup, deleteProductGroup, getProductGroupWithProducts, putProductGroupWithProducts, postProductGroupWithProducts } from '../../../../api/nomenclature/productGroups';
