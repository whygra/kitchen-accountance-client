...
import { ProductCategoryDTO, getProductCategoryWithProducts, putProductCategoryWithProducts, postProductCategoryWithProducts } from '../../../../api/nomenclature/productCategories';
