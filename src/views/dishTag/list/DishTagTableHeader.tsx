...
import { EMPTY_SEARCH_PARAMS, SearchParams } from "../../../hooks/filter/useFilterDishTags"
...
interface DishTagsTableHeaderProps {
    filtersOpen? : boolean
    toggleSort: (field:DishTagField)=>void
    activeField: DishTagField
    sortIsDesc: boolean
...
export default DishTagsTableHeader