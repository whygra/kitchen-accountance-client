...
interface InventoryActProductFormProps {
  formState: InventoryActProductFormState,
  openSelect: (form:InventoryActProductFormState)=>void,
}

function InventoryActProductForm({formState, openSelect}: InventoryActProductFormProps) {
...
export default InventoryActProductForm;