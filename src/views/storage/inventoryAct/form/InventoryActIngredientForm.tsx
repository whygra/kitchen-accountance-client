...
interface InventoryActIngredientFormProps {
  formState: InventoryActIngredientFormState,
  openSelect: (form:InventoryActIngredientFormState)=>void,
}

function InventoryActIngredientForm({formState, openSelect}: InventoryActIngredientFormProps) {
...
export default InventoryActIngredientForm;