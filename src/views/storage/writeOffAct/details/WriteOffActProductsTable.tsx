...
function WriteOffActProductsTable({writeOffAct}:WriteOffActProductsTableProps) {
        
    const {sliceLimits, nav} = usePagination(writeOffAct.products?.length??0)
...
export default WriteOffActProductsTable;