...
import WriteOffActProductForm from './WriteOffActProductForm'
...
function WriteOffActProductFormList() {
      ...
      <Form.Label><b>Продукты:</b></Form.Label>
      {
        formState.productForms
          ...
          <div key={`${formState.key}`}>
            <WriteOffActProductForm openSelect={openSelect} formState={formState}/>
          </div>)
      }
...
export default WriteOffActProductFormList;