...
import { EMPTY_SEARCH_PARAMS, SearchParams } from "../../../hooks/filter/useFilterIngredientTags"
...
interface IngredientTagsTableHeaderProps {
    filtersOpen? : boolean
    toggleSort: (field:IngredientTagField)=>void
    activeField: IngredientTagField
    sortIsDesc: boolean
...
function IngredientTagsTableHeader({
    toggleSort,
    activeField,
    sortIsDesc,
    searchData,
    ...
    fieldsToExclude,
    filtersOpen
}:IngredientTagsTableHeaderProps){
...
export default IngredientTagsTableHeader