import ProductCategoryProductFormList from '../form/ProductCategoryProductFormList';
...
{  
  ...
  async function commit() {
    ...
    try{
      ...
      navigate(`/product-categories/details/${res?.id}`)
    }
  ...
  return (<>
        ...
        <ProductCategoryProductFormList/>
