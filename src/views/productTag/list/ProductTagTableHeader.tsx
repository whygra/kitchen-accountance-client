...
import { EMPTY_SEARCH_PARAMS, SearchParams } from "../../../hooks/filter/useFilterProductTags"
...
interface ProductTagsTableHeaderProps {
    filtersOpen? : boolean
    toggleSort: (field:ProductTagField)=>void
    activeField: ProductTagField
    sortIsDesc: boolean
...
function ProductTagsTableHeader({
    toggleSort,
    activeField,
    sortIsDesc,
    searchData,
...
export default ProductTagsTableHeader